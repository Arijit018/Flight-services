...
function validateCreateRequest(req, res, next) {
    ...
    if (compareTime(req.body.arrivalTime, req.body.departureTime)
        ...
        ErrorResponse.message = 'Something went wrong while entering the arrival time and deparure time';
        ErrorResponse.error = new AppError(['arriva and departure time is not found in the oncoming request in the correct form'], StatusCodes.BAD_REQUEST);
        return res
            .status(StatusCodes.BAD_REQUEST)
            .json(ErrorResponse);
...
module.exports = {
    validateCreateRequest, validateUpdateSeatsRequest
}